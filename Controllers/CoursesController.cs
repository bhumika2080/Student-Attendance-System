...
namespace Student_Attendance_System.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public CoursesController(Student_Attendance_SystemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Course != null ?
                        ...
                        Problem("Entity set 'Student_Attendance_SystemContext.Course'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Student_Attendance_SystemContext.Course'  is null.");
            }
            var course = await _context.Course.FindAsync(id);
            if (course != null)
            {
